    ...
    <section id="research" className="my-12">
      <div className="bg-white p-8 rounded-lg shadow-md transform transition-transform duration-700 ease-in-out hover:scale-105">
        <h2 className="text-3xl font-bold mb-6 flex items-center text-blue-600">
          <FaChartBar className="mr-3 animate-bounce" />
          Investigación y Datos
        </h2>
        <p className="mb-6 text-gray-700 leading-relaxed transform transition-transform duration-500 hover:scale-105">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-blue-100 p-6 rounded-lg shadow transform transition-transform duration-500 hover:scale-105">
            ...
            <p className="text-sm text-gray-500 mt-2">Extraído de <a href="https://es.statista.com/estadisticas/541434/numero-mundial-de-usuarios-de-internet/" className="text-blue-600 underline">Statista</a></p>
          </div>
          <div className="bg-green-100 p-6 rounded-lg shadow transform transition-transform duration-500 hover:scale-105">
            ...
            <p className="text-sm text-gray-500 mt-2">Extraído de <a href="https://es.statista.com/estadisticas/1327038/promedio-de-tiempo-de-uso-diario-de-internet/" className="text-green-600 underline">Statista</a></p>
          </div>
        </div>
      </div>
    </section>
